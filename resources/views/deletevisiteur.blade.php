    ...
    <head>
     ...
     <body>
        <div class="card" style="text-align: center;">
         <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Supprimer un visteur</h3>
             <form class="needs-validation">
                 <div class="form-row" style="padding : 0 20%">
                     ...
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control" id="nom" placeholder="Dumontet">
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                     <div class="mb-3">
                         <label for="pseudo">Prénom</label>
                         <input type="text" class="form-control" id="prenom" placeholder="Lola">
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                     <div class="mb-3">
                        <label for="pseudo">Âge</label>
                        <input type="text" class="form-control" id="age" placeholder="23">
                        <div class="valid-feedback">Ok !</div>
                        <div class="invalid-feedback">Valeur incorrecte</div>
                    </div>
                    <div class="mb-3">
                        <label for="pseudo">Poste occupé</label>
                        <input type="text" class="form-control" id="poste" placeholder="Stagiaire">
                        <div class="valid-feedback">Ok !</div>
                        <div class="invalid-feedback">Valeur incorrecte</div>
                    </div>
                 </div>
                 <a class="btn btn-outline-success my-2 my-sm-0" type="submit" href="{{route('goVisiteur')}}">Supprimer</a>
             </form>
         </div>
         <script>
           (function() {
