    ...
    <head>
     ...
     <body>
        <div class="card" style="text-align: center;">
         <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Supprimer un véhicule</h3>
             <form class="needs-validation">
                 <div class="form-row" style="padding : 0 20%">
                     <div class="mb-3">
                         <label for="cp">ID</label>
                         <input type="number" class="form-control" id="identifiant" placeholder="19" name="identifiant">
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                     <div class="mb-3">
                         <label for="nom">Modèle</label>
                         <input type="text" class="form-control" id="loggin" placeholder="a.martin@pompier.fr">
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                     <div class="mb-3">
                         <label for="pseudo">Dernière révision</label>
                         <input type="text" class="form-control" id="mot de passe" placeholder="13/02/2012">
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                     <div class="mb-3">
                        <label for="nom">Etat</label>
                        <input type="text" class="form-control" id="etatt" placeholder="Disponible">
                        <div class="valid-feedback">Ok !</div>
                        <div class="invalid-feedback">Valeur incorrecte</div>
                    </div>
                    <div class="mb-3">
                        <label for="pseudo">Utilisateur actuel</label>
                        <input type="text" class="form-control" id="utilisateur" placeholder="123">
                        <div class="valid-feedback">Ok !</div>
                        <div class="invalid-feedback">Valeur incorrecte</div>
                    </div>
                 </div>
                 <a class="btn btn-outline-success my-2 my-sm-0" type="submit" href="{{route('goVehicule')}}">Supprimer</a>
             </form>
         </div>
         <script>
           (function() {
