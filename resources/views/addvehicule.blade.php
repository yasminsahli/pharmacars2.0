    ...
    <head>
     ...
     <body>
        <div class="card" style="text-align: center;">
         <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Ajouter un véhicule</h3>
             <form class="needs-validation" novalidate>
                 ...
                 <a class="btn btn-outline-success my-2 my-sm-0" type="submit" href= "{{route('goVehicule')}}">Envoyer</a>
             </form>
         </div>
         <script>
           (function() {
