    ...
    <head>
     ...
     <body>
        <div class="card" style="text-align: center;">
         <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Supprimer un formulaire</h3>
             <form class="needs-validation">
                 <div class="form-row" style="padding : 0 20%">
                     ...
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control" id="mot de passe" placeholder="1234azeR">
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                     <div class="mb-3">
                          <label for="cp">Poste occupé</label>
                          <input type="number" class="form-control" id="identifiant" placeholder="19" name="identifiant">
                          <div class="valid-feedback">Ok !</div>
                          <div class="invalid-feedback">Valeur incorrecte</div>
                      </div>
                      <div class="mb-3">
                          <label for="nom">Durée d'utilisation</label>
                          <input type="text" class="form-control" id="loggin" placeholder="a.martin@pompier.fr">
                          <div class="valid-feedback">Ok !</div>
                          <div class="invalid-feedback">Valeur incorrecte</div>
                      </div>
                      <div class="mb-3">
                          <label for="pseudo">Nombre de km parcourus</label>
                          <input type="text" class="form-control" id="mot de passe" placeholder="1234azeR">
                          <div class="valid-feedback">Ok !</div>
                          <div class="invalid-feedback">Valeur incorrecte</div>
                      </div>
                 </div>
                 <a class="btn btn-outline-success my-2 my-sm-0" type="submit" href="{{route('goFormulaire')}}">Supprimer</a>
             </form>
         </div>
         <script>
           (function() {
