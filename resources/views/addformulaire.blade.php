    ...
    <head>
     ...
     <body>
        <div class="card" style="text-align: center;">
         <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Ajouter un formulaire</h3>
             <form class="needs-validation" novalidate>
                 <div class="form-row" style="padding : 0 20%">
                     <div class="mb-3">
                         <label for="cp">ID Formulaire</label>
                         <input type="text" class="form-control" id="numcaserne" placeholder="19" required>
                 ...
                 <div class="form-row" style = "padding : 0 20%">
                     ...
                     <div class="mb-3">
                          <label for="ville">Permis</label>
                          <input type="number" min="B" max="BE"class="form-control" id="ville" placeholder="Consultant" required>
                          <div class="valid-feedback">Ok !</div>
                          <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                 </div>
                 <div class="form-row" style = "padding : 0 20%">
                      <div class="mb-3">
                          ...
                          <input type="number" class="form-control" id="ville" placeholder="En jours" required>
                          <div class="valid-feedback">Ok !</div>
                          <div class="invalid-feedback">Valeur incorrecte</div>
                      </div>
                      <div class="mb-3">
